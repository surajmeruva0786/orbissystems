      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 p-6">
            ...
            <div className="lg:col-span-2">
              <div className="flex items-start justify-between mb-4">
                <div>
                  <h1 className="text-4xl font-bold text-[#0C0714] mb-2" style={{ fontFamily: "'Instrument Sans', sans-serif" }}>
                    {animal.name}
                  </h1>
                  <p className="text-xl text-purple-600 font-medium mb-3" style={{ fontFamily: "'DM Sans', sans-serif" }}>
                    {animal.nameHindi}
                  </p>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                <div className="bg-purple-50 rounded-lg p-4">
                  <p className="text-xs text-purple-600 font-medium mb-1" style={{ fontFamily: "'DM Sans', sans-serif" }}>
                    Age
                  </p>
                  <p className="text-2xl font-bold text-[#0C0714]" style={{ fontFamily: "'Instrument Sans', sans-serif" }}>
                    {animal.age}
                  </p>
                ...
                <div className="bg-purple-50 rounded-lg p-4 md:col-span-2">
                  ...
                  <p className="text-lg font-bold text-[#0C0714]" style={{ fontFamily: "'Instrument Sans', sans-serif" }}>
                    {animal.enclosure}
                  </p>
                </div>
              </div>
            ...
            <div className="space-y-4">
              {mockMedicalRecords.map((record) => (
                <div key={record.id} className="border border-gray-100 rounded-lg p-4">
                  ...
                  {record.medication && (
                    <p className="text-sm text-purple-700 mb-2" style={{ fontFamily: "'DM Sans', sans-serif" }}>
        ...
        <div className="mt-6 bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
          ...
          <div className="space-y-4">
            {logs.length > 0 ? (
              logs.map((log) => (
                <div key={log.id} className="border border-gray-100 rounded-lg p-5 hover:shadow-md transition-shadow">
                  <div className="flex items-start justify-between mb-3">
                    <div>
                      <h3 className="text-lg font-bold text-[#0C0714] mb-1" style={{ fontFamily: "'Instrument Sans', sans-serif" }}>
                  ...
                  {log.notes && (
                    <div className="bg-purple-50 rounded-lg p-3">
                      <p className="text-sm text-purple-900" style={{ fontFamily: "'DM Sans', sans-serif" }}>
